...
- Generate score categories dynamically based on the code.
- Generate exactly 4 relevant score categories in scoreBreakdown.
- Choose the 4 most relevant categories based on the provided code.
...
export async function main(code,language) {
    ...
    let final_prompt = SYSTEM_PROMPT_ANALYZE +  `\n\nLanguage: ${language}\n\nCode to review:\n${code}`;
